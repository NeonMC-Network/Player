...
public class CheckPermissionCommand extends FilterCommand {
    ...
    public CheckPermissionCommand(AbstractCommand next, String permission, String mes_noPermission) {
        ...
        if (mes_noPermission == null) throw new NullPointerException("mes_noPermission cannot be null.");
     ...
     * 若没有继承本类并重写本方法, 则将会把预设的{@link #MES_NO_PERMISSION}发给命令执行的来源
     * 发送的信息没有任何替换
     * 
     * @param sender
     *            命令执行的来源
