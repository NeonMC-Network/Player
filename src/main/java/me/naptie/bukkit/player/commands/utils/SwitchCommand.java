...
public class SwitchCommand extends AbstractCommand {
     ...
     * @param mes_noArgs
     *            见: {@link #MES_NO_ARGS}
     * @param mes_noArgsCase
     *            见: {@link #MES_NO_ARGS_CASE} 若为null则指向 {@link #MES_NO_ARGS}
     * @param toLowerCase
     *            见: {@link #TO_LOWER_CASE}
     * @param cases
     *            见: {@link #CASES}
     */
    public SwitchCommand(String mes_noArgs, String mes_noArgsCase, boolean toLowerCase,
            Map<String, AbstractCommand> cases) {
        if (mes_noArgs == null) throw new NullPointerException("mes_noArgs cannot be null.");
        if (mes_noArgsCase == null) mes_noArgsCase = mes_noArgs;
        if (cases == null) throw new NullPointerException("cases cannot be null.");
